...
const slides = [
  ...
  {
    id: 4,
    title: "Общие черты НИС",
    subtitle: "Что объединяет новые индустриальные страны",
    tag: "НИС",
    image: "https://cdn.poehali.dev/projects/b001a868-3031-4851-8bbc-be7b22055faa/files/c5218818-44ee-4377-a4f3-4ae757d9d6e6.jpg",
    section: "05",
    sectionName: "Черты НИС",
    color: "#C05A10",
    isCover: false,
    body: "НИС — страны, совершившие стремительный переход от аграрной к индустриальной экономике за 2–3 десятилетия. Общие черты: высокая доля промышленности в ВВП (30–40%), ориентация на экспорт, активное привлечение иностранных инвестиций, дешёвая и дисциплинированная рабочая сила, государственное планирование и поддержка ключевых отраслей.",
    facts: [
      { icon: "Factory", label: "Пром. доля ВВП", value: "30–40%" },
      { icon: "BarChart2", label: "Рост ВВП/год", value: "5–8%" },
      { icon: "Landmark", label: "Модель", value: "Экспортная" },
    ],
  },
  {
    id: 5,
    title: "Факторы успеха и проблемы",
    subtitle: "Два лица индустриального роста",
    tag: "Анализ",
    image: "https://cdn.poehali.dev/projects/b001a868-3031-4851-8bbc-be7b22055faa/files/8f942f6d-9463-4f49-8e49-44680b87cba8.jpg",
    section: "06",
    sectionName: "Факторы и проблемы",
    color: "#1A7A6A",
    isCover: false,
    body: "Факторы успеха: выгодное географическое положение, дешёвый труд, открытость иностранному капиталу, государственные инвестиции в образование и инфраструктуру. Проблемы: социальное расслоение, зависимость от экспорта и внешних рынков, экологический ущерб от индустриализации, коррупция и политическая нестабильность.",
    facts: [
      { icon: "CheckCircle", label: "Главный фактор", value: "Дешёвый труд" },
      { icon: "AlertTriangle", label: "Главная проблема", value: "Неравенство" },
      { icon: "Leaf", label: "Экология", value: "Под угрозой" },
    ],
  },
  {
    id: 6,
    title: "Экономика",
    subtitle: "Структура и движущие силы роста",
    tag: "Экономика",
    image: "https://cdn.poehali.dev/projects/b001a868-3031-4851-8bbc-be7b22055faa/files/4f1bcc15-96e7-405a-9cc8-d5e0bd980c76.jpg",
    section: "07",
    sectionName: "Экономика",
    color: "#1060A8",
    isCover: false,
    body: "Экономика Таиланда держится на трёх китах: промышленность (электроника, автомобили, текстиль), сельское хозяйство (рис, каучук, сахарный тростник) и туризм — 20% ВВП. Страна входит в топ-10 мировых экспортёров риса и натурального каучука. Бангкок — финансовый центр всей Юго-Восточной Азии.",
    facts: [
      { icon: "PieChart", label: "Туризм в ВВП", value: "~20%" },
      { icon: "Wheat", label: "Экспорт риса", value: "Топ-3 мира" },
      { icon: "DollarSign", label: "Доход на душу", value: "$7 200/год" },
    ],
  },
  {
    id: 7,
    title: "Вывод",
    subtitle: "Таиланд — витрина азиатского роста",
    tag: "Заключение",
    image: "https://cdn.poehali.dev/projects/b001a868-3031-4851-8bbc-be7b22055faa/files/75c86055-3447-4028-8281-c523d0a591ae.jpg",
    section: "08",
    sectionName: "Вывод",
    color: "#C8960C",
    isCover: false,
    body: "Таиланд — яркий пример новой индустриальной страны, сумевшей за полвека превратиться из аграрного государства в одну из ключевых экономик Азии. Уникальное сочетание природных ресурсов, выгодного положения, открытой экономики и трудолюбивого населения обеспечило стране место на мировой арене. Сохранение этих достижений требует решения социальных и экологических проблем.",
    facts: [
      { icon: "Star", label: "Статус", value: "НИС 2-го поколения" },
      { icon: "Globe", label: "Регион", value: "ЮВА — лидер" },
      { icon: "ArrowUpRight", label: "Перспектива", value: "Высокий потенциал" },
    ],
  },
  {
    id: 8,
